...
In order to support loading of multiple wallets in poseidon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is poseidon.cpp.
...
Changes to poseidon.cpp
----------------------
poseidon.cpp is the entry point into poseidon-qt, and as such, will require some minor modifications to provide hooks for
