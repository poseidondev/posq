...
In order to support loading of multiple wallets in posq-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is posq.cpp.
...
Changes to posq.cpp
----------------------
posq.cpp is the entry point into posq-qt, and as such, will require some minor modifications to provide hooks for
