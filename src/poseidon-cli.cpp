...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Poseidon Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  poseidon-cli [options] <command> [params]  " + _("Send command to Poseidon Core") + "\n" +
                        "  poseidon-cli [options] help                " + _("List commands") + "\n" +
                        "  poseidon-cli [options] help <command>      " + _("Get help for a command") + "\n";
