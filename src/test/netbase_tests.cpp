...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:5510", "127.0.0.1", 5510));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5510", "127.0.0.1", 5510));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5510", "::ffff:127.0.0.1", 5510));
    BOOST_CHECK(TestSplitHost("[::]:5510", "::", 5510));
    BOOST_CHECK(TestSplitHost("::5510", "::5510", -1));
    BOOST_CHECK(TestSplitHost(":5510", "", 5510));
    BOOST_CHECK(TestSplitHost("[]:5510", "", 5510));
