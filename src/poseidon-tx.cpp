...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Poseidon Core poseidon-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  poseidon-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded poseidon transaction") + "\n" +
                               "  poseidon-tx [options] -create [commands]   " + _("Create hex-encoded poseidon transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded poseidon transaction
