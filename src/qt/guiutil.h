...
/** Utility functions used by the Poseidon Qt UI.
 */
namespace GUIUtil
{
...
// Render Poseidon addresses in monospace font
...
// Parse "poseidon:" URI into recipient object, return true on successful parsing
