...
QT_TRANSLATE_NOOP("posq-core", ""
"Disable all Posq specific functionality (Masternodes, Obfuscation, SwiftX, "
...
QT_TRANSLATE_NOOP("posq-core", ""
"To use posqd, or the -server option to posq-qt, you must set an rpcpassword "
...
QT_TRANSLATE_NOOP("posq-core", "(5520 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("posq-core", "(default: %s)"),
QT_TRANSLATE_NOOP("posq-core", "(default: 1)"),
QT_TRANSLATE_NOOP("posq-core", "(must be 5520 for mainnet)"),
...
QT_TRANSLATE_NOOP("posq-core", "Acceptable ciphers (default: %s)"),
...
QT_TRANSLATE_NOOP("posq-core", "Copyright (C) 2017-%i The Posq Core Developers"),
QT_TRANSLATE_NOOP("posq-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("posq-core", "Could not parse -rpcbind value %s as network address"),
...
QT_TRANSLATE_NOOP("posq-core", "Failed to read block index"),
QT_TRANSLATE_NOOP("posq-core", "Failed to read block"),
QT_TRANSLATE_NOOP("posq-core", "Failed to write block index"),
...
QT_TRANSLATE_NOOP("posq-core", "Invalid -proxy address or hostname: '%s'"),
...
QT_TRANSLATE_NOOP("posq-core", "Less than 3 mints added, unable to create spend"),
...
QT_TRANSLATE_NOOP("posq-core", "Percentage of automatically minted Zerocoin  (10-100, default: %u)"),
...
QT_TRANSLATE_NOOP("posq-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("posq-core", "RPC server options:"),
QT_TRANSLATE_NOOP("posq-core", "RPC support for HTTP persistent connections (default: %d)"),
...
QT_TRANSLATE_NOOP("posq-core", "Recalculating coin supply may take 30-60 minutes..."),
QT_TRANSLATE_NOOP("posq-core", "Recalculating supply statistics may take 30-60 minutes..."),
...
QT_TRANSLATE_NOOP("posq-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("posq-core", "Server private key (default: %s)"),
...
QT_TRANSLATE_NOOP("posq-core", "Use OpenSSL (https) for JSON-RPC connections"),
...
QT_TRANSLATE_NOOP("posq-core", "failed to validate zerocoin"),
