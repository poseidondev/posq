Contributing to POSQ Core
============================

The POSQ Core project operates an open contributor model where anyone is
...
The following applies to code changes to the POSQ Core project, and is not to be
confused with overall POSQ Network Protocol consensus changes.

Whether a pull request is merged into POSQ Core rests with the project merge
...
Patches that change POSQ consensus rules are considerably more involved than
...
Where a patch set proposes to change the POSQ consensus, it must have been
...
The project leader is the release manager for each POSQ Core release.
