Contributing to Poseidon Core
============================

The Poseidon Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Poseidon Core project, and is not to be
confused with overall Poseidon Network Protocol consensus changes.

Whether a pull request is merged into Poseidon Core rests with the project merge
...
Patches that change Poseidon consensus rules are considerably more involved than
...
Where a patch set proposes to change the Poseidon consensus, it must have been
...
The project leader is the release manager for each Poseidon Core release.
